...
debugUI.addFolder('DirectionalLight').add(helpers.directionalLight, 'visible').setValue(false)
debugUI.addFolder('SpotLight').add(helpers.spotlight, 'visible').setValue(false)
